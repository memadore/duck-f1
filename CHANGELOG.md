...
* docs: update live timing dataset availability (#112) ([`16c2cc1`](https://github.com/memadore/duck-f1/commit/16c2cc12bfaee1fa7b535400bf311421eaee874a))

* docs: update live timing dataset availability (#108) ([`69b9119`](https://github.com/memadore/duck-f1/commit/69b9119a728c7ca0bf259d7e4ee402b8d21d4405))

* docs: add dbt instructions to readme (#107) ([`ae6eac9`](https://github.com/memadore/duck-f1/commit/ae6eac9605ab0ac2cb079a54c8f5fa79b0402b7a))

### Feature

* feat: add countries seed file (#114) ([`ef7c21f`](https://github.com/memadore/duck-f1/commit/ef7c21f03a976a0dd1499a24706c1f2886e3ab9d))

* feat: add constructor championship to intermediate model (#111)

* feat: add constructor championship to intermediate model

* style: formatting ([`1fc7ed7`](https://github.com/memadore/duck-f1/commit/1fc7ed72c992573717f3a1b53b8c6b1b8f77ce0b))

### Fix

* fix(ci): remove @memadore as reviewer for pr requests (#115) ([`e978c85`](https://github.com/memadore/duck-f1/commit/e978c8519d372fe7f6dcf972b3b096ddfe035166))
## v0.1.0 (2024-09-22)
...
Automatically generated by python-semantic-release ([`066c6ac`](https://github.com/memadore/duck-f1/commit/066c6acf791ac3d966475b62224bf297eeacbad0))

* build: prepare pyproject.toml for publication (#90) ([`f7a014a`](https://github.com/memadore/duck-f1/commit/f7a014aec473e1992af4d11f4c3c74fa08267b16))

### Documentation

* docs: update live timing dataset availability (#106) ([`2eb1d07`](https://github.com/memadore/duck-f1/commit/2eb1d07961a13ebc67dd24b83c45e1f0e3ce2cb0))

* docs: update live timing dataset availability (#96) ([`5eb4fe4`](https://github.com/memadore/duck-f1/commit/5eb4fe4475c17078602496864c871210cb1c2a77))

* docs: add basic readme page (#97) ([`faf5666`](https://github.com/memadore/duck-f1/commit/faf56661dd59cb0b55034eeff917ec68d68b0903))
...
* fix(ci): add missing backslash to script (#105) ([`83df139`](https://github.com/memadore/duck-f1/commit/83df1394c95588c9050722d362677a6bae008419))

* fix(ci): add missing python version variable (#104) ([`13354bb`](https://github.com/memadore/duck-f1/commit/13354bb8a0f8b17722b317571018bdfb5107e769))

* fix: incremental pipeline for the live timing availability (#94) ([`70ffc0c`](https://github.com/memadore/duck-f1/commit/70ffc0cc0ea178b6bd291c0ee9c3d474df6e1f5b))
