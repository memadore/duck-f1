...
ergast_sessions as (
    select
        ...
        null::integer as session_timestamp_local
    from {{ ref("stg_ergast__sessions") }}
    where session_timestamp_utc < '2018-01-01'::date
),
...
ergast_live_timing_sessions as (
    select
        ...
        _session.session_timestamp_utc
...
live_timing_sessions as (
    select
        ...
        ergast_session.session_timestamp_utc,
        live_timing_session.session_timestamp_local
